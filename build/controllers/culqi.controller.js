...
var _culqi = _interopRequireDefault(require("../configCq/culqi.config"));
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          producto = req.body; // const {}} = req.body;
          // if(!producto)console.log("producto vacio");
          console.log(producto);
          _context2.prev = 2;
          _context2.next = 5;
          return _culqi["default"].tokens.createToken({
            ...
            var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(token) {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return _culqi["default"].charges.createCharge({
